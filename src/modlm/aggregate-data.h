...
typedef std::pair<std::vector<float>, std::vector<std::pair<int, float> > > AggregateTarget;

// A set of aggregate training instances
typedef std::pair<AggregateContext, std::vector<std::pair<AggregateTarget, int> > > AggregateInstance;
